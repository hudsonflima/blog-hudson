...
const ContactInfo = () => {
  return (
    <div className="mt-4">
      <p className="text-sm text-slate-800 dark:text-slate-300">Entre em contato:</p>
      <p className="text-sm text-slate-800 dark:text-slate-300">Email: hudsonflima@gmail.com</p>
      <p className="text-sm text-slate-800 dark:text-slate-300">Telefone: +55 (41) 98704-7876</p>
    </div>
  );
};
  ...
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl p-1">
      <button
        ...
        className="flex items-center h-full pr-2 dark:bg-primary rounded-3xl justify-center align-center p-2 w-24 sm:h-10 transition"
      >
        {moonIcon}
      </button>
      ...
      <button
        ...
        className="flex items-center h-full pr-2 bg-primary dark:bg-transparent rounded-3xl justify-center align-center p-2 w-24 sm:h-10 transition"
      >
        {sunIcon}
      </button>
    </div>
